#line 1 "F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c"
...
#line 18 "F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c"
#line 1 "F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\zairkiss\\EWARM-RELEASE\\..\\..\\..\\component\\common\\mbed\\hal\\spi_api.h"
...
#line 29 "F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\zairkiss\\EWARM-RELEASE\\..\\..\\..\\component\\common\\mbed\\hal\\spi_api.h"
...
#line 19 "F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c"
#line 1 "F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\project\\zairkiss\\EWARM-RELEASE\\..\\..\\..\\component\\common\\mbed\\hal_ext\\spi_ex_api.h"
...
#line 20 "F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c"
...
#line 22 "F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c"
...
static uint32_t ssi_int_read(void *Adapter, void *RxData, uint32_t Length)
{
	...
	((Length != 0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 194));
...
static uint32_t ssi_int_write(void *Adapter, uint8_t *pTxData, uint32_t Length)
{
	...
	((Length != 0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 223));
...
static uint32_t ssi_dma_send(void *Adapter, uint8_t *pTxData, uint32_t Length)
{
	...
	((Length != 0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 292));
	((pTxData != 0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 293));
...
static uint32_t ssi_dma_recv(void *Adapter, uint8_t  *pRxData, uint32_t Length)
{
	...
	((Length != 0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 317));
	((pRxData != 0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 318));
...
void spi_init (spi_t *obj, PinName mosi, PinName miso, PinName sclk, PinName ssel)
{
	...
	if ((obj->spi_idx != MBED_SPI0) && (obj->spi_idx != MBED_SPI1)) {
		...
		((0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 401));
	}
...
void spi_format (spi_t *obj, int bits, int mode, int slave)
{
	...
	if (slave == 1) {
		if (spi_idx == 0) {
			...
			((0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 562));
		}
	} else {
		if (spi_idx == 1) {
			ssi_adapter->Role = (1);
		} else {
			((0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 568));
		}
	}
...
void spi_slave_select(spi_t *obj, ChipSelect slaveindex)
{
	...
	if((ssi_adapter->Role == (1)) && (spi_idx == 1)){
		...
		((0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 609));
	}
}
...
#line 985 "F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c"
	return (ret == (!0)) ? HAL_OK : HAL_BUSY;
}
...
int32_t spi_slave_read_stream_dma_timeout(spi_t *obj, char *rx_buffer, uint32_t length, uint32_t timeout_ms)
{
	...
	((timeout_ms > 0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 1068));
...
int32_t spi_slave_read_stream_timeout(spi_t *obj, char *rx_buffer, uint32_t length, uint32_t timeout_ms)
{
	...
	((timeout_ms > 0) ? (void)0 : io_assert_failed((uint8_t *)"F:\\RTLworkSpace\\00009982-sdk-ameba-v4.0c\\sdk-ameba-v4.0c\\component\\common\\mbed\\targets\\hal\\rtl8711b\\spi_api.c", 1189));
