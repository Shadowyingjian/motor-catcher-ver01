...
extern int rtl_crypto_aes_ecb_init( const uint8_t* key,  const uint32_t keylen);
...
extern int rtl_crypto_aes_ecb_encrypt(
	 ...
	 const uint8_t* iv, 		 const uint32_t ivlen, 
	 uint8_t* pResult);
extern int rtl_crypto_aes_cbc_init( const uint8_t* key, 	 const uint32_t keylen);
...
extern int rtl_crypto_des_cbc_init( const uint8_t* key,  const uint32_t keylen);
...
extern int rtl_crypto_des_cbc_encrypt(
	 ...
	 const uint8_t* iv, 		 const uint32_t ivlen, 
	 uint8_t* pResult);
extern int rtl_crypto_3des_cbc_init( const uint8_t* key,  const uint32_t keylen);
